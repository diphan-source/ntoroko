...
<!-- Mirrored from st.ourhtmldemo.com/new/PureHearts/donation-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 13:05:54 GMT -->
<head>
<meta charset="utf-8">
                        ...
                        <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                            <div class="case-details-content">
                                <div class="content-one">
                                    <figure class="image-box"><img src="assets/images/case/case-21.jpg" alt=""></figure>
                                    <div class="text">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12 single-column">
                                                <div class="single-item">
                                                    ...
                                                    <div class="content-box">
                                                        ...
                                                        <h3>Volunteer</h3>
                                                        <h6><a href="volunteer.php">Join as Volunteer</a></h6>
                                                    </div>
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12 single-column">
                                                <div class="single-item">
                                                    ...
                                                    <div class="content-box">
                                                        ...
                                                        <h3>By Shopping</h3>
                                                        <h6><a href="products.php">Our products</a></h6>
                                                    </div>
                                                    <div class="overlay-content">
                                                        <p>He rejects pleasures secure other great pleasure or else endures.</p>
                                                        <h6><a href="products.php">Our products</a></h6>
                        ...
                        <div class="col-lg-4 col-md-12 col-sm-12 sidebar-side">
                            <div class="case-sidebar default-sidebar">
                                <div class="sidebar-widget search-widget">
                                    <form action="https://st.ourhtmldemo.com/new/PureHearts/donation-details.php" method="post" class="search-form">
                                        <div class="form-group">
                                ...
                                <div class="sidebar-widget category-widget">
                                    ...
                                    <div class="widget-content">
                                        <ul class="category-list clearfix">
                                            <li><a href="donation-details.php">CONTRIBUTIONS<span>06</span></a></li>
                                            <li><a href="donation-details.php">Environment<span>08</span></a></li>
                                            <li><a href="donation-details.php">Heath & Food<span>03</span></a></li>
                                            <li><a href="donation-details.php">Treatment<span>14</span></a></li>
                                            <li><a href="donation-details.php">National Day<span>12</span></a></li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <ul class="image-list clearfix">
                                            <li>
                                                <figure class="image">
                                                    ...
                                                    <a href="donation-details.php"><i class="fas fa-expand-alt"></i></a>
                                                </figure>
                                            </li>
                                            <li>
                                                <figure class="image">
...
<!-- Mirrored from st.ourhtmldemo.com/new/PureHearts/donation-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 13:06:01 GMT -->
</html>
