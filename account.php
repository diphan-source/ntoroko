...
<!-- Mirrored from st.ourhtmldemo.com/new/PureHearts/account.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 13:06:18 GMT -->
<head>
<meta charset="utf-8">
                ...
                <div class="row clearfix">
                    <div class="col-lg-6 col-md-12 col-sm-12 column">
                        <div class="login-inner">
                            <h3>Login</h3>
                            <form action="https://st.ourhtmldemo.com/new/PureHearts/account.php" method="post" class="login-form">
                                <div class="form-group">
                            ...
                            <ul class="other-option clearfix">
                                ...
                                <li><a href="account.php"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="account.php"><i class="fab fa-twitter"></i></a></li>
                                <li><a href="account.php"><i class="fab fa-google-plus-g"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-sm-12 column">
                        <div class="register-inner">
                            <h3>Register</h3>
                            <form action="https://st.ourhtmldemo.com/new/PureHearts/account.php" method="post" class="register-form">
                                <div class="form-group">
                                    <i class="fas fa-user"></i>
                                    <input type="text" name="name" placeholder="Your Name*" required="">
                                </div>
