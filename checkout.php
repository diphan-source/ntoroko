...
<!-- Mirrored from st.ourhtmldemo.com/new/PureHearts/checkout.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 13:06:18 GMT -->
<head>
<meta charset="utf-8">
                                    ...
                                    <div class="field-input">
                                        <div class="custom-controls-stacked">
                                            <label class="custom-control material-checkbox">
                                                ...
                                                <span class="description">Get Product Updates & Offers</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="field-input">
                                                <div class="custom-controls-stacked">
                                                    <label class="custom-control material-checkbox">
                                                        <input type="checkbox" class="material-control-input">
                                                        <span class="material-control-indicator"></span>
                                                        <span class="description">Save for future shopping</span>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="order-summary">
                                ...
                                <div class="inner-box">
                                    <div class="single-item">
                                        ...
                                        <h6>£25.99*2<span>£51.98</span></h6>
                                    </div>
                                    <div class="single-item">
                                        <h5>Kids Zebra Soft Toy</h5>
                                        <h6>£23.99*3<span>£71.97</span></h6>
                                    </div>
                                </div>
                                <ul class="total-box clearfix">
                                    <li>Sub total<span>£123.95</span></li>
                                    <li>Shipping<span>£30.00</span></li>
                                    <li>Tax<span>£0.00</span></li>
                                </ul>
                                <div class="total-amount">
                                    <h5>Total (Including Tax)<span>£153.90</span></h5>
                                </div>
                                <div class="btn-box">
                                    <a href="checkout.php" class="theme-btn btn-one">Continue</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12 column">
                                            <div class="field-input message-btn">
                                                <button type="button" class="theme-btn btn-one">Make Payment</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
