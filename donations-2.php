...
<!-- Mirrored from st.ourhtmldemo.com/new/PureHearts/donations-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 13:05:52 GMT -->
<head>
<meta charset="utf-8">
            ...
            <div class="auto-container">
                <div class="row clearfix">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 case-block">
                        <div class="case-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img src="assets/images/case/case-13.jpg" alt=""></figure>
                                <div class="lower-content">
                                    <div class="shape" style="background-image: url(assets/images/shape/shape-11.png);"></div>
                                    <div class="donate-amount clearfix">
                                        <div class="amount-box">
                                    ...
                                    <div class="inner">
                                        <div class="text">
                                            <div class="category"><a href="donation-details.php"># Treatment</a></div>
                                            <h3><a href="donation-details.php">Fundraise for COVID-19</a></h3>
                                            <p>Equal blame belongs to those who fail in their duty through weakness.</p>
                                        </div>
                                        <ul class="info-box clearfix">
                                            <li>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 case-block">
                        <div class="case-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img src="assets/images/case/case-14.jpg" alt=""></figure>
                                <div class="lower-content">
                                    <div class="shape" style="background-image: url(assets/images/shape/shape-11.png);"></div>
                                    <div class="donate-amount clearfix">
                                        <div class="amount-box">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 case-block">
                        <div class="case-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img src="assets/images/case/case-15.jpg" alt=""></figure>
                                <div class="lower-content">
                                    <div class="shape" style="background-image: url(assets/images/shape/shape-11.png);"></div>
                                    <div class="donate-amount clearfix">
                                        <div class="amount-box">
                                    ...
                                    <div class="inner">
                                        <div class="text">
                                            <div class="category"><a href="donation-details.php"># Health & Food</a></div>
                                            <h3><a href="donation-details.php">Little Help it can Bring Big</a></h3>
                                            <p>Indignation and dislike men who are like most beguiled demoralized.</p>
                                        </div>
                                        <ul class="info-box clearfix">
                                            <li>
...
<!-- Mirrored from st.ourhtmldemo.com/new/PureHearts/donations-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 13:05:53 GMT -->
</html>
