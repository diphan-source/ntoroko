                        ...
                        <div class="blog-details-content">
                            ...
                            <div class="post-share-option clearfix">
                                <ul class="tags-list pull-left clearfix">
                                    ...
                                    <li><a href="blog-details.php">benefits</a></li>
                                    <li><a href="blog-details.php">education</a></li>
                                </ul>
                                <ul class="social-links pull-right clearfix">
                                    ...
                                    <li><a href="blog-details.php"><i class="fab fa-pinterest-p"></i></a></li>
                                </ul>
                            </div>
                            <div class="author-box">
                                ...
                                <div class="content-box">
                                    ...
                                    <h6>Visit Blog Page: <a href="blog-details.php">http://my.blog.com</a></h6>
                            ...
                            <div class="comment-box">
                                ...
                                <div class="comment">
                                    ...
                                    <div class="comment-inner">
                                        ...
                                        <a href="blog-details.php" class="reply-btn"><i class="icon-reply"></i>Reply</a>
                                    </div>
                                </div>
                            ...
                            <div class="comments-form-area">
                                ...
                                <div class="form-inner">
                                    <form method="post" action="https://st.ourhtmldemo.com/new/PureHearts/blog-details.php" class="comment-form"> 
                                        <div class="row clearfix">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 sidebar-side">
                        <div class="blog-sidebar default-sidebar">
                            <div class="sidebar-widget search-widget">
                                <form action="https://st.ourhtmldemo.com/new/PureHearts/blog-details.php" method="post" class="search-form">
                                    <div class="form-group">
                            ...
                            <div class="sidebar-widget category-widget">
                                ...
                                <div class="widget-content">
                                    <ul class="category-list clearfix">
                                        <li><a href="blog-details.php">CONTRIBUTIONS<span>06</span></a></li>
                                        <li><a href="blog-details.php">Environment<span>08</span></a></li>
                                        <li><a href="blog-details.php">Heath & Food<span>03</span></a></li>
                                        <li><a href="blog-details.php">Treatment<span>14</span></a></li>
                                        <li><a href="blog-details.php">National Day<span>12</span></a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="sidebar-widget post-widget">
                                ...
                                <div class="post-inner">
                                    <div class="post">
                                        <figure class="post-thumb"><a href="blog-details.php"><img src="assets/images/news/post-4.jpg" alt=""></a></figure>
                                        <h5><a href="blog-details.php">Aid for Country: The Charity for Orphans</a></h5>
                                        <span class="post-date">03.03.2021</span>
                                    </div>
                                    <div class="post">
                                        <figure class="post-thumb"><a href="blog-details.php"><img src="assets/images/news/post-5.jpg" alt=""></a></figure>
                                        <h5><a href="blog-details.php">I Want to Get Every People Volunteer...</a></h5>
                                        <span class="post-date">24.02.2021</span>
                                    </div>
                                    <div class="post">
                                        <figure class="post-thumb"><a href="blog-details.php"><img src="assets/images/news/post-6.jpg" alt=""></a></figure>
                                        <h5><a href="blog-details.php">The Last Day of World Hunger Month</a></h5>
                            ...
                            <div class="sidebar-widget tags-widget">
                                ...
                                <div class="widget-content">
                                    <ul class="tags-list clearfix">
                                        <li><a href="blog-details.php">activities</a></li>
                                        <li><a href="blog-details.php">awareness</a></li>
                                        <li><a href="blog-details.php">benefits</a></li>
                                        <li><a href="blog-details.php">education</a></li>
                                        <li><a href="blog-details.php">environment</a></li>
                                        <li><a href="blog-details.php">gift card</a></li>
                                        <li><a href="blog-details.php">heath</a></li>
                                        <li><a href="blog-details.php">protection</a></li>
                                        <li><a href="blog-details.php">women care</a></li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <ul class="image-list clearfix">
                                        <li>
                                            <figure class="image">
                                                ...
                                                <a href="blog-details.php"><i class="fas fa-expand-alt"></i></a>
                                            </figure>
                                        </li>
                                        <li>
                                            <figure class="image">
