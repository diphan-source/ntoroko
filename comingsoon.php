...
<!-- Mirrored from st.ourhtmldemo.com/new/PureHearts/comingsoon.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 13:05:34 GMT -->
<head>
<meta charset="utf-8">
...
<body>
    ...
    <div class="boxed_wrapper">
        ...
        <section class="comingsoon-section">
            ...
            <div class="auto-container">
                <div class="content-box centred">
                    <h3>Event Name</h3>
                    <h2>Coming Soon</h2>
                    <p>Idea of denouncing pleasure and praising pain was born & we will give you  a complete account of system.</p>
                    <div class="timer">
                        <div class="cs-countdown" data-countdown="06/24/2021 05:06:59"></div>
                    </div>
                    <div class="btn-box"><a href="comingsoon.php" class="theme-btn btn-one">Reminder</a></div>
                </div>
            </div>
        </section>
        ...
        <!-- subscribe-section -->
        <section class="subscribe-section comingsoon-page">
            <div class="auto-container">
