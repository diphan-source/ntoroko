                        ...
                        <div class="content_block_6">
                            <div class="content-box">
                                ...
                                <div class="text">
                                    ...
                                    pleasure of the moment so blinded by desire that they cannot foresee the pain trouble
                                ...
                                <div class="tabs-content">
                                    <div class="tab active-tab" id="tab-1">
                                        <div class="text">
                                            ...
                                            <a href="about.php"><i class="far fa-angle-right"></i>Read More</a>
                                        </div>
                                    </div>
                        ...
                        <div class="content_block_7">
                            <div class="content-box">
                                ...
                                <div class="text">
                                    ...
                                    <a href="about.php" class="theme-btn btn-one">Download</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="progress-inner">
                                    <div class="single-progress-box">
                                        ...
                                        <div class="text">
                                            ...
                                            <a href="about.php"><i class="far fa-angle-right"></i>View Details</a>
                                        </div>
                                    </div>
                                    <div class="single-progress-box">
                                        <div class="box">
        ...
        <section class="funfact-section alternat-2 centred" style="background-image: url(../assets/images/background/10.jpg);">
            <div class="auto-container">
                <div class="sec-title light centred">
                    ...
                    <h2>Ntoroko Development Network Facts & Figures</h2>
