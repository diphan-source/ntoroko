                        ...
                        <div class="content_block_1">
                            <div class="content-box">
                                ...
                                <div class="funfact-inner">
                                    ...
                                    <div class="counter-block-one wow fadeInRight animated animated" data-wow-delay="500ms" data-wow-duration="1500ms">
                                        <div class="inner-box">
                                            <div class="icon-box"><i class="icon-donation-1"></i></div>
                                            <div class="count-outer count-box">
                                                <span class="count-text" data-speed="1500" data-stop="500">0</span><span>k</span>
                                            </div>
                                            <h4>Beneficiaries</h4>
                                        </div>
                                    </div>
                                            ...
                                            <div class="inner-box">
                                                ...
                                                <div class="lower-content">
                                                    ...
                                                    <div class="donate-amount clearfix">
                                                        ...
                                                        <div class="percentage-box">
                                                            <div class="bar">
                                                                <div class="bar-inner count-bar" data-percent="3%"></div>
                                                            </div>
                                    ...
                                    <div class="three-item-carousel owl-carousel owl-theme owl-dots-none">
                                        <div class="case-block-one">
                                            <div class="inner-box">
                                                <figure class="image-box"><img src="../assets/images/ndn/training.jpg" alt=""></figure>
                                                <div class="lower-content">
                                                    <div class="shape" style="background-image: url(../assets/images/ndn/training.jpg);"></div>
                                                    <div class="donate-amount clearfix">
                                                        <div class="amount-box">
                                                            <!-- <div class="icon-box"><i class="fas fa-dollar-sign"></i></div> -->
                                                            <h5>Target</h5>
                ...
                <div class="inner-box">
                    ...
                    <div class="inner">
                        <div class="sec-title centred light">
                            <span class="top-text">Our partners</span>
                            <h2>We dont stand alone but choose team work<br />for High Impact Causes</h2>
                            <p>it is not only one person's work, it's really a partnership and collaboration during all these years and a deciated team </p>
                        </div>
                        <div class="single-item-carousel owl-carousel owl-theme owl-dots-none">
                            <div class="single-item">
                                <figure class="image-box">
                                    <a href="https://cidiuganda.org/" targert="_blank">
                                        <img src="../assets/images/ndn/partners/cidi.jpg" height="500" width="500" alt="">
                                    </a>
                                </figure>
                                <!-- <div class="text">
                                <h3><link CIDI</link></h3>
                                    <h6>Volunteer</h6>
                                </div> -->
                            </div>
                            <div class="single-item">
                                <figure class="image-box"><a href="https://www.health.go.ug/" targert="_blank"><img src="../assets/images/ndn/partners/health3.jpg" height="200" width="1000" alt=""></a></figure>
                                <!-- <div class="text">
                            ...
                            <div class="single-item">
                                ...
                                <!-- <div class="text">
                                    <h3><link Ministry of Agriculture</link></h3>
                                    </div> -->
                            </div>
                            <div class="single-item">
                                <figure class="image-box"><a href="https://www.ewb-usa.org/" targert="_blank"><img src="../assets/images/ndn/partners/engineers.jpg" height="500" width="500" alt=""></a></figure>
                                <!-- <div class="text">
                                    <h3><link Engineers without boarders</link></h3>
                                    </div> -->
                            </div>
                            <div class="single-item">
                                <figure class="image-box"><a href="https://www.parliament.go.ug/" targert="_blank"><img src="../assets/images/ndn/partners/par-ug.png" height="200" width="1500" alt=""></a></figure>
                                <!-- <div class="text">
                                    <h3><link Parliament of Uganda</link></h3>
                                    </div> -->
                            </div>
                            <div class="single-item">
                                <figure class="image-box"><a href="http://www.mwe.go.ug/" targert="_blank"><img src="../assets/images/ndn/partners/water2.jpg" height="200" width="1000" alt=""></a></figure>
                                <!-- <div class="text">
                                    <h3><link >Ministry of Water and Environment</link></h3>
                                    </div> -->
                            </div>
                            <div class="single-item">
                                <figure class="image-box"><a href="https://westminsterfoundation.org.uk/" targert="_blank"><img src="../assets/images/ndn/partners/westminster.jpg" height="500" width="500" alt=""></a></figure>
                                <!-- <div class="text">
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 inner-column">
                        <div class="right-column">
                            ...
                            <div class="events-block-one wow fadeInRight animated" data-wow-delay="500ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    <div class="shape" style="background-image: url(../assets/images/shape/shape-20.png);"></div>
                                    <figure class="image-box">
        ...
        <div class="auto-container">
            ...
            <div class="four-item-carousel owl-carousel owl-theme owl-nav-none">
                <div class="team-block-one">
                    <div class="inner-box">
                        <figure class="image-box"><img src="../assets/images/ndn/mag/william.jpeg" alt=""></figure>
                        <div class="content-box">
                            <div class="info">
