...
<!-- Mirrored from st.ourhtmldemo.com/new/PureHearts/donations.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 13:05:49 GMT -->
<head>
<meta charset="utf-8">
                ...
                <div class="row clearfix">
                    <div class="col-lg-6 col-md-12 col-sm-12 case-block">
                        <div class="case-block-three">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><img src="assets/images/case/case-7.jpg" alt=""></figure>
                                    <div class="text">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 case-block">
                        <div class="case-block-three">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><img src="assets/images/case/case-8.jpg" alt=""></figure>
                                    <div class="text">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 case-block">
                        <div class="case-block-three">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><img src="assets/images/case/case-9.jpg" alt=""></figure>
                                    <div class="text">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 case-block">
                        <div class="case-block-three">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><img src="assets/images/case/case-10.jpg" alt=""></figure>
                                    <div class="text">
                                        <div class="category"><a href="donation-details.php"># Treatment</a></div>
                                        <h3><a href="donation-details.php">Fundraise for COVID-19 Relief</a></h3>
                                    </div>
                                </div>
                                <div class="lower-content">
                                    <div class="pattern-layer" style="background-image: url(assets/images/shape/shape-7.png);"></div>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 case-block">
                        <div class="case-block-three">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><img src="assets/images/case/case-11.jpg" alt=""></figure>
                                    <div class="text">
                                        <div class="category"><a href="donation-details.php"># Education</a></div>
                                        <h3><a href="donation-details.php">Education Kit for Poor Girls</a></h3>
                                    </div>
                                </div>
                                <div class="lower-content">
                                    <div class="pattern-layer" style="background-image: url(assets/images/shape/shape-7.png);"></div>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 case-block">
                        <div class="case-block-three">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><img src="assets/images/case/case-12.jpg" alt=""></figure>
                                    <div class="text">
                                        <div class="category"><a href="donation-details.php"># Hunger & Nutrition</a></div>
...
<!-- Mirrored from st.ourhtmldemo.com/new/PureHearts/donations.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 13:05:52 GMT -->
</html>
