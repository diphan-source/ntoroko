...
<!-- Mirrored from st.ourhtmldemo.com/new/PureHearts/events-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 13:06:02 GMT -->
<head>
<meta charset="utf-8">
                            ...
                            <nav class="main-menu navbar-expand-md navbar-light">
                                <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li class="current dropdown"><a href="index.php">Events</a>
                                            <ul>
                        ...
                        <div class="events-list-content">
                            ...
                            <div class="events-block-one wow fadeInLeft animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    ...
                                    <div class="inner">
                                        ...
                                        <h3><a href="event-details.php">One-Day Online Fundraiser</a></h3>
                                        <p>On the other handdenounce with righteous indignations dislike men who are so beguiled.</p>
                                        <div class="links"><a href="event-details.php">More Details</a></div>
                                        <div class="price"><h6>$180.00</h6></div>
                                    </div>
                            ...
                            <div class="events-block-one wow fadeInLeft animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    ...
                                    <div class="inner">
                                        ...
                                        <h3><a href="event-details.php">Personal Fitness Challenge</a></h3>
                                        <p>Trouble that are bound to ensue; and equal blame belongs to those who fail in their duty.</p>
                                        <div class="links"><a href="event-details.php">More Details</a></div>
                                        <div class="price"><h6>For Free</h6></div>
                                    </div>
                            ...
                            <div class="pagination-wrapper centred">
                                <ul class="pagination clearfix">
                                    <li><a href="events-2.php"><i class="fas fa-arrow-left"></i></a></li>
                                    <li><a href="events-2.php" class="current">1</a></li>
                                    <li><a href="events-2.php">2</a></li>
                                    <li><a href="events-2.php"><i class="fas fa-arrow-right"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12 col-sm-12 sidebar-side">
                        <div class="events-sidebar default-sidebar">
                            <div class="sidebar-widget search-widget">
                                <form action="https://st.ourhtmldemo.com/new/PureHearts/events-2.php" method="post" class="search-form">
                                    <div class="form-group">
                            ...
                            <div class="sidebar-widget category-widget">
                                ...
                                <div class="widget-content">
                                    <ul class="category-list clearfix">
                                        <li><a href="events-2.php">CONTRIBUTIONS<span>06</span></a></li>
                                        <li><a href="events-2.php">Environment<span>08</span></a></li>
                                        <li><a href="events-2.php">Heath & Food<span>03</span></a></li>
                                        <li><a href="events-2.php">Treatment<span>14</span></a></li>
                                        <li><a href="events-2.php">National Day<span>12</span></a></li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <ul class="image-list clearfix">
                                        <li>
                                            <figure class="image">
                                                ...
                                                <a href="events-2.php"><i class="fas fa-expand-alt"></i></a>
                                            </figure>
                                        </li>
                                        <li>
                                            <figure class="image">
...
<!-- Mirrored from st.ourhtmldemo.com/new/PureHearts/events-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 13:06:06 GMT -->
</html>
