...
<!-- Mirrored from st.ourhtmldemo.com/new/PureHearts/donations-3.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 13:05:53 GMT -->
<head>
<meta charset="utf-8">
                            ...
                            <nav class="main-menu navbar-expand-md navbar-light">
                                <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li class="current dropdown"><a href="index.php">Donations</a>
                                            <ul>
        ...
        <section class="case-page-section list-view">
            <div class="auto-container">
                <div class="case-block-four">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><img src="assets/images/case/case-16.jpg" alt=""></figure>
                        ...
                        <div class="content-box">
                            <div class="text">
                                ...
                                <p>Indignation and dislike men who are like most beguiled demoralized demoralized charms of pleasure of the moment.</p>
                            </div>
                            <ul class="info-box clearfix">
                                ...
                                <li class="share">
                                    ...
                                    <h5><a href="index.php">Share</a></h5>
                                    <ul class="social-links clearfix">
                                        <li><a href="donations.php"><i class="fab fa-facebook-f"></i></a></li>
                                        <li><a href="donations.php"><i class="fab fa-twitter"></i></a></li>
                                        <li><a href="donations.php"><i class="fab fa-google-plus-g"></i></a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="case-block-four">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><img src="assets/images/case/case-17.jpg" alt=""></figure>
                            <div class="donate-inner clearfix">
                                <div class="pattern-layer" style="background-image: url(assets/images/shape/shape-8.png);"></div>
                                <div class="amount-box">
                                    <div class="icon-box"><i class="fas fa-dollar-sign"></i></div>
                        ...
                        <div class="content-box">
                            <div class="text">
                                ...
                                <p>These cases are perfectly simple and easy to distinguish a free hour when our power of choice is untrammelled.</p>
                            </div>
                            <ul class="info-box clearfix">
                                <li>
                                    <i class="far fa-calendar-alt"></i>
                ...
                <div class="case-block-four">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><img src="assets/images/case/case-18.jpg" alt=""></figure>
                            <div class="donate-inner clearfix">
                                <div class="pattern-layer" style="background-image: url(assets/images/shape/shape-8.png);"></div>
                                <div class="amount-box">
                                    <div class="icon-box"><i class="fas fa-dollar-sign"></i></div>
                ...
                <div class="case-block-four">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><img src="assets/images/case/case-19.jpg" alt=""></figure>
                            <div class="donate-inner clearfix">
                                <div class="pattern-layer" style="background-image: url(assets/images/shape/shape-8.png);"></div>
                                <div class="amount-box">
                                    <div class="icon-box"><i class="fas fa-dollar-sign"></i></div>
                        ...
                        <div class="content-box">
                            <div class="text">
                                <div class="category"><a href="donation-details.php"># Hunger & Nutrition</a></div>
                                <h3><a href="donation-details.php">Sponsor Milk & Bread to 200 Poor People in GH</a></h3>
                                <p>These cases are perfectly simple and easy to distinguish a free hour when our power of choice is untrammelled.</p>
                            </div>
                            <ul class="info-box clearfix">
                                <li>
                ...
                <div class="case-block-four">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><img src="assets/images/case/case-20.jpg" alt=""></figure>
                            <div class="donate-inner clearfix">
                                <div class="pattern-layer" style="background-image: url(assets/images/shape/shape-8.png);"></div>
                                <div class="amount-box">
                                    <div class="icon-box"><i class="fas fa-dollar-sign"></i></div>
                ...
                <div class="pagination-wrapper centred">
                    <ul class="pagination clearfix">
                        <li><a href="donations.php"><i class="fas fa-arrow-left"></i></a></li>
                        <li><a href="donations.php" class="current">1</a></li>
                        <li><a href="donations.php">2</a></li>
                        <li><a href="donations.php">3</a></li>
                        <li><a href="donations.php"><i class="fas fa-arrow-right"></i></a></li>
                    </ul>
                </div>
            </div>
        </section>
...
<!-- Mirrored from st.ourhtmldemo.com/new/PureHearts/donations-3.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 13:05:54 GMT -->
</html>
