<div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="index.php"><img src="assets/images/ndn/ndn4.jpeg" alt="" title=""></a></div>
                <div class="menu-outer"><!--Here Menu Will Come Automatically Via Javascript / Same Menu as in Header--></div>
                <div class="contact-info">
                    <h4>Contact Info</h4>
                    <ul>
                        <li>Local Community Centre , Ntoroko District, Uganda</li>
                        <li><a href="tel:+8801682648101">+2567770000</a></li>
