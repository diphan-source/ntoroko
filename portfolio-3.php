...
<!-- Mirrored from st.ourhtmldemo.com/new/PureHearts/portfolio-3.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 13:05:41 GMT -->
<head>
<meta charset="utf-8">
            ...
            <div class="auto-container">
                <div class="sortable-masonry">
                    ...
                    <div class="items-container row clearfix">
                        <div class="col-lg-3 col-md-6 col-sm-12 masonry-item small-column all education activities awareness helping">
                            <div class="portfolio-block-one">
                                <div class="inner-box">
                                    <figure class="image"><img src="assets/images/gallery/portfolio-16.jpg" alt=""></figure>
                                    <div class="content-box">
                                        <ul class="links-list clearfix">
                                            <li><a href="portfolio-2.php"><i class="fas fa-expand-alt"></i></a></li>
                                            <li><a href="portfolio-2.php"><i class="far fa-file-alt"></i></a></li>
                                        </ul>
                                        <div class="text">
                                            <span>Activities</span>
                                            <h3><a href="portfolio-2.php">Educate Children</a></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12 masonry-item small-column all activities education health helping">
                            <div class="portfolio-block-one">
                                <div class="inner-box">
                                    <figure class="image"><img src="assets/images/gallery/portfolio-17.jpg" alt=""></figure>
                                    <div class="content-box">
                                        <ul class="links-list clearfix">
                                            <li><a href="portfolio-2.php"><i class="fas fa-expand-alt"></i></a></li>
                                            <li><a href="portfolio-2.php"><i class="far fa-file-alt"></i></a></li>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 masonry-item small-column all education awareness">
                            <div class="portfolio-block-one">
                                <div class="inner-box">
                                    <figure class="image"><img src="assets/images/gallery/portfolio-18.jpg" alt=""></figure>
                                    <div class="content-box">
                                        <ul class="links-list clearfix">
                                            <li><a href="portfolio-2.php"><i class="fas fa-expand-alt"></i></a></li>
                                            <li><a href="portfolio-2.php"><i class="far fa-file-alt"></i></a></li>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 masonry-item small-column all activities awareness health helping">
                            <div class="portfolio-block-one">
                                <div class="inner-box">
                                    <figure class="image"><img src="assets/images/gallery/portfolio-19.jpg" alt=""></figure>
                                    <div class="content-box">
                                        <ul class="links-list clearfix">
                                            <li><a href="portfolio-2.php"><i class="fas fa-expand-alt"></i></a></li>
                                            <li><a href="portfolio-2.php"><i class="far fa-file-alt"></i></a></li>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 masonry-item small-column all education awareness">
                            <div class="portfolio-block-one">
                                <div class="inner-box">
                                    <figure class="image"><img src="assets/images/gallery/portfolio-20.jpg" alt=""></figure>
                                    <div class="content-box">
                                        <ul class="links-list clearfix">
                                            <li><a href="portfolio-2.php"><i class="fas fa-expand-alt"></i></a></li>
                                            <li><a href="portfolio-2.php"><i class="far fa-file-alt"></i></a></li>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 masonry-item small-column all activities awareness health helping">
                            <div class="portfolio-block-one">
                                <div class="inner-box">
                                    <figure class="image"><img src="assets/images/gallery/portfolio-21.jpg" alt=""></figure>
                                    <div class="content-box">
                                        <ul class="links-list clearfix">
                                            <li><a href="portfolio-2.php"><i class="fas fa-expand-alt"></i></a></li>
                                            <li><a href="portfolio-2.php"><i class="far fa-file-alt"></i></a></li>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 masonry-item small-column all activities awareness health helping">
                            <div class="portfolio-block-one">
                                <div class="inner-box">
                                    <figure class="image"><img src="assets/images/gallery/portfolio-22.jpg" alt=""></figure>
                                    <div class="content-box">
                                        <ul class="links-list clearfix">
                                            <li><a href="portfolio-2.php"><i class="fas fa-expand-alt"></i></a></li>
                                            <li><a href="portfolio-2.php"><i class="far fa-file-alt"></i></a></li>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 masonry-item small-column all education awareness">
                            <div class="portfolio-block-one">
                                <div class="inner-box">
                                    <figure class="image"><img src="assets/images/gallery/portfolio-23.jpg" alt=""></figure>
                                    <div class="content-box">
                                        <ul class="links-list clearfix">
                                            <li><a href="portfolio-2.php"><i class="fas fa-expand-alt"></i></a></li>
                                            <li><a href="portfolio-2.php"><i class="far fa-file-alt"></i></a></li>
                ...
                <div class="pagination-wrapper">
                    <ul class="pagination clearfix">
                        <li><a href="portfolio-3.php"><i class="fas fa-arrow-left"></i></a></li>
                        <li><a href="portfolio-3.php" class="current">1</a></li>
                        <li><a href="portfolio-3.php">2</a></li>
                        <li><a href="portfolio-3.php"><i class="fas fa-arrow-right"></i></a></li>
                    </ul>
                </div>
            </div>
        </section>
...
<!-- Mirrored from st.ourhtmldemo.com/new/PureHearts/portfolio-3.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 13:05:46 GMT -->
</html>
