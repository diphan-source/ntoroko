...
<!-- Mirrored from st.ourhtmldemo.com/new/PureHearts/product-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 13:06:17 GMT -->
<head>
<meta charset="utf-8">
    ...
    <div class="boxed_wrapper">
                            ...
                            <nav class="main-menu navbar-expand-md navbar-light">
                                <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li class="current dropdown"><a href="index.php">Shop</a>
                                            <ul>
        ...
        <section class="shop-details">
            <div class="auto-container">
                <div class="basic-details">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                            <figure class="image-box"><a href="assets/images/resource/shop/shop-9.jpg" class="lightbox-image" data-fancybox="gallery"><img src="assets/images/resource/shop/shop-9.jpg" alt=""></a></figure>
                        </div>
                        <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                            <div class="product-details-content">
                                <div class="upper-box">
                                    <h3>Talking Tom Toy for Kids</h3>
                                    <div class="rating-box clearfix">
                                        ...
                                        <div class="review-box"><a href="product-details.php">[3 Customer Reviews]</a></div>
                                    </div>
                                ...
                                <div class="text">
                                    ...
                                    <ul class="category clearfix">
                                        ...
                                        <li><a href="product-details.php">Kids,</a></li>
                                        <li><a href="product-details.php">Toys,</a></li>
                                        <li><a href="product-details.php">Entertainment</a></li>
                                    </ul>
                                </div>
                                <div class="benefits-box">
                                    <ul class="list clearfix">
                                        <li>Certified Product</li>
                                        <li>$30 for Shipping</li>
                                ...
                                <div class="quantity-box">
                                    ...
                                    <div class="inner clearfix">
                                        ...
                                        <div class="cart-btn">
                                            <button type="button" class="theme-btn btn-one">Add to Cart</button>
                                        </div>
                                        <div class="like-box">
                                            <a href="product-details.php"><i class="icon-heart-shape-outline"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="share-box">
                                    ...
                                    <ul class="social-links clearfix">
                                        <li><a href="product-details.php"><i class="fab fa-facebook-f"></i></a></li>
                                        <li><a href="product-details.php"><i class="fab fa-twitter"></i></a></li>
                                        <li><a href="product-details.php"><i class="fab fa-google-plus-g"></i></a></li>
                                        <li><a href="product-details.php"><i class="fab fa-youtube"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="tab active-tab" id="tab-2">
                                ...
                                <div class="customer-comments">
                                    ...
                                    <div class="form-inner">
                                        <form action="https://st.ourhtmldemo.com/new/PureHearts/product-details.php" method="post" class="review-form">
                                            <div class="row clearfix">
                ...
                <div class="related-product centred">
                    <div class="title-box">
                            ...
                            <div class="shop-block-one wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    ...
                                    <div class="lower-content">
                                        ...
                                        <h5><a href="product-details.php">Smart Horse Cycle</a></h5>
                                        <div class="price"><h5>£49.00</h5></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="shop-block-one wow fadeInUp animated animated" data-wow-delay="200ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    ...
                                    <div class="lower-content">
                                        ...
                                        <h5><a href="product-details.php">Tortoise Reptile Toy</a></h5>
                            ...
                            <div class="shop-block-one wow fadeInUp animated animated" data-wow-delay="400ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    ...
                                    <div class="lower-content">
                                        ...
                                        <h5><a href="product-details.php">3d Wooden Decorates</a></h5>
