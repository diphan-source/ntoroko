...
<!-- Mirrored from st.ourhtmldemo.com/new/PureHearts/index-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 13:03:35 GMT -->
<head>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">

<title>PureHearts - HTML 5 Template Preview</title>
    ...
    <div class="boxed_wrapper red-color">
        ...
        <header class="main-header header-style-two">
                    ...
                    <div class="top-inner clearfix">
                        <div class="left-column pull-left clearfix">
                            <ul class="links-list clearfix">
                                <li><a href="index-2.php">Why Join?</a></li>
                                <li><a href="index-2.php">Gift Cards</a></li>
                                <li><a href="index-2.php">FAQ’s</a></li>
                                <li><a href="index-2.php">Resources</a></li>
                            </ul>
                            <ul class="info-list clearfix">
                                <li><i class="icon-phone-call"></i>Call Us: <a href="tel:23345678901">+233 456 789 01</a></li>
                                <li><i class="icon-letter"></i>Email Us: <a href="mailto:info@example.com">mailto:info@example.com</a></li>
                            </ul>
                        </div>
                        <div class="right-column pull-right clearfix">
                            ...
                            <div class="text">
                                <p>We only have what we give... <button class="donate-box-btn">Donate Now</button></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="header-lower">
                <div class="outer-container">
                    <div class="outer-box">
                        <div class="text">
                            <figure class="icon-box"><img src="assets/images/icons/heart-4.png" alt=""></figure>
                                    ...
                                    <ul class="navigation clearfix">
                                            ...
                                            <ul>
                                                ...
                                                <li class="dropdown"><a href="index.php">Portfolio</a>
                                                    <ul>
                                                        ...
                                                        <li><a href="portfolio-2.php">3 Columns Grid</a></li>
                                                        <li><a href="portfolio-3.php">4 Columns Grid</a></li>
                                                        <li><a href="portfolio-details.php">Portfolio Details</a></li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        </li> 
                                        <li class="dropdown"><a href="index.php">Donations</a>
                                            <ul>
                                                <li><a href="donations.php">2 Columns Grid</a></li>
                                                <li><a href="donations-2.php">3 Columns Grid</a></li>
                                                <li><a href="donations-3.php">List View</a></li>
                                        ...
                                        <li class="dropdown"><a href="index.php">Blog</a>
                                            <ul>
                                                ...
                                                <li><a href="blog-2.php">List View</a></li>
                        ...
                        <div class="nav-right-content clearfix">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu search-panel" aria-labelledby="dropdownMenu3">
                                        <div class="form-container">
                                            <form method="post" action="https://st.ourhtmldemo.com/new/PureHearts/blog.php">
                            ...
                            <div class="cart-box">
                                <a href="products.php"><i class="icon-shopping-bag"></i></a>
                            </div>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="auto-container">
                                <div class="content-box">
                                    <figure class="icon-layer"><img src="assets/images/icons/heart-5.png" alt=""></figure>
                                    ...
                                    <div class="btn-box">
                                        <a href="index-2.php" class="banner-btn">Read More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            ...
                            <div class="auto-container">
                                <div class="content-box">
                                    ...
                                    <h2>Spread Joy</h2>
                                    <p>A small contribution you make today will shape a better <br />future for tomorrow</p>
                                    <div class="btn-box">
                                        <a href="index-2.php" class="banner-btn">Read More</a>
                                    </div>
                                </div>
                ...
                <div class="row clearfix">
                    <div class="col-lg-3 col-md-6 col-sm-12 welcome-block">
                        <div class="welcome-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><img src="assets/images/resource/welcome-1.jpg" alt=""></figure>
                                <div class="content-box">
                                ...
                                <div class="btn-box">
                                    <a href="index-2.php" class="links"><i class="icon-right-arrow"></i></a>
                                    <a href="index-2.php" class="links-btn"><i class="icon-right-arrow"></i>Read More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12 welcome-block">
                        <div class="welcome-block-one wow fadeInUp animated" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><img src="assets/images/resource/welcome-2.jpg" alt=""></figure>
                                <div class="content-box">
                                    <div class="shape" style="background-image: url(assets/images/shape/shape-32.png);"></div>
                                    <div class="text">
                                        <span>Join With Us</span>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 welcome-block">
                        <div class="welcome-block-one wow fadeInUp animated" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><img src="assets/images/resource/welcome-3.jpg" alt=""></figure>
                                <div class="content-box">
                                    <div class="shape" style="background-image: url(assets/images/shape/shape-32.png);"></div>
                                    <div class="text">
                                        <span>Join With Us</span>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 welcome-block">
                        <div class="welcome-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><img src="assets/images/resource/welcome-4.jpg" alt=""></figure>
                                <div class="content-box">
                                    <div class="shape" style="background-image: url(assets/images/shape/shape-32.png);"></div>
                                    <div class="text">
                                        <span>Join With Us</span>
        ...
        <section class="case-style-two sec-pad">
            <div class="pattern-layer">
                <div class="pattern-1" style="background-image: url(assets/images/shape/shape-33.png);"></div>
                <div class="pattern-2" style="background-image: url(assets/images/shape/shape-34.png);"></div>
            </div>
            <figure class="icon-layer"><img src="assets/images/icons/heart-6.png" alt=""></figure>
            <div class="auto-container">
                ...
                <div class="three-item-carousel owl-carousel owl-theme owl-nav-none">
                        ...
                        <div class="inner-box">
                            <div class="image-box">
                                ...
                                <div class="percentage-box">
                                    <h5>Goal: $80,000</h5>
                                    <div class="bar">
                                        <div class="bar-inner count-bar counted" data-percent="53%"></div>
                                    </div>
                                    <div class="count-text">53% Raised <span>-$37,600</span></div>
                                </div>
                            </div>
                            <div class="lower-content">
                                <div class="text">
                                    <div class="category"><a href="donation-details.php"># Health & Food</a></div>
                    ...
                    <div class="case-block-two">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><img src="assets/images/case/case-5.jpg" alt=""></figure>
                                <div class="percentage-box">
                                    <h5>Goal: $65,000</h5>
                                    <div class="bar">
                                        <div class="bar-inner count-bar counted" data-percent="24%"></div>
                                    </div>
                                    <div class="count-text">24% Raised <span>-$49,400</span></div>
                                </div>
                            </div>
                            <div class="lower-content">
                                <div class="text">
                                    ...
                                    <p>Blinded by desire that they cannot the pain and trouble bound too.</p>
                                </div>
                                <ul class="info-box clearfix">
                                    <li>
                                        <i class="far fa-calendar-alt"></i>
                    ...
                    <div class="case-block-two">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><img src="assets/images/case/case-6.jpg" alt=""></figure>
                                <div class="percentage-box">
                                    <h5>Goal: $50,000</h5>
                                    <div class="bar">
                                        <div class="bar-inner count-bar counted" data-percent="76%"></div>
                                    </div>
                                    <div class="count-text">76% Raised <span>-$12,000</span></div>
                                </div>
                            </div>
                            <div class="lower-content">
                                <div class="text">
        ...
        <!-- benefits-style-two -->
        <section class="benefits-style-two" style="background-image: url(assets/images/background/8.jpg);">
            <div class="auto-container">
                <div class="inner-container">
                    <div class="row clearfix">
                        <div class="col-lg-4 col-md-12 col-sm-12 small-column">
                            <div class="inner-box">
                                ...
                                <div class="text">
                                    <span>Benefits of Giving</span>
                                    <h2>Bring More Meaning to Your Life & Family</h2>
                                    <p>Ever undertake laborious physical except obtain some advantage</p>
                                    <a href="index-2.php" class="theme-btn btn-one">Read More</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-6 col-md-6 col-sm-12 single-column">
                                    <div class="single-item">
                                        <figure class="image-box"><img src="assets/images/resource/benefits-2.jpg" alt=""></figure>
                                        <div class="text">
                                            <div class="icon-box"><i class="icon-stop-hand-drawn-signal-rhomb"></i></div>
                                            <h3><a href="index-2.php">Improve Self Esteem</a></h3>
                                            <p>Righteous and dislike mens who beguiled ...</p>
                                            <div class="link"><a href="index-2.php"><i class="icon-right-arrow"></i></a></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12 single-column">
                                    <div class="single-item">
                                        <figure class="image-box"><img src="assets/images/resource/benefits-3.jpg" alt=""></figure>
                                        <div class="text">
                                            <div class="icon-box"><i class="icon-financial-bar-chart"></i></div>
                                            <h3><a href="index-2.php">Financial Benefits</a></h3>
                                            <p>Righteous and dislike mens who beguiled ...</p>
                                            <div class="link"><a href="index-2.php"><i class="icon-right-arrow"></i></a></div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 single-column">
                                    <div class="single-item">
                                        <figure class="image-box"><img src="assets/images/resource/benefits-4.jpg" alt=""></figure>
                                        <div class="text">
                                            <div class="icon-box"><i class="icon-puzzle-piece-shape-handmade-draw"></i></div>
                                            <h3><a href="index-2.php">Reduce Your Stress</a></h3>
                                            <p>Obligations business frequently pleasure it  to be repudiate ...</p>
                                            <div class="link"><a href="index-2.php"><i class="icon-right-arrow"></i></a></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12 single-column">
                                    <div class="single-item">
                                        <figure class="image-box"><img src="assets/images/resource/benefits-5.jpg" alt=""></figure>
                                        <div class="text">
                                            <div class="icon-box"><i class="icon-house-with-heart-hand-drawn-building"></i></div>
                                            <h3><a href="index-2.php">Familial Benefits</a></h3>
                                            <p>Obligations business frequently pleasure it to be repudiate ...</p>
                                            <div class="link"><a href="index-2.php"><i class="icon-right-arrow"></i></a></div>
                                        </div>
                                    </div>
                        ...
                        <div class="content_block_4">
                            <div class="content-box">
                                ...
                                <div class="rotate-text">
                                    <figure class="text-box rotate-me"><img src="assets/images/icons/rotate-text.png" alt=""></figure>
                                    <figure class="icon-box"><img src="assets/images/icons/bird-1.png" alt=""></figure>
                                </div>
                                <div class="chart-box">
                                    <figure class="chart-image"><img src="assets/images/icons/chart-1.png" alt=""></figure>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 content-column">
                        <div class="content_block_5">
                            <div class="content-box">
                                ...
                                <div class="text">
                                    <p>There are many variations of passages of lorem ipsum available, but the majority have suffered all form injected humours.</p>
                                </div>
                                <div class="inner-box">
                                    <div class="single-item">
                                        <div class="icon-box"><i class="icon-loving"></i></div>
                                        <h3>Who We Are</h3>
                                        <p>Frequently occur that pleasures have to be repudiated accepted the wise man ...</p>
                                    </div>
                                    <div class="single-item">
                                        <div class="icon-box"><i class="icon-helping-hand"></i></div>
                                        <h3>Our Promises</h3>
                                        <p>No one rejects dislike or avoids pleasure itself because it is but know how to pursue ...</p>
                                    </div>
                                </div>
                                <div class="btn-box">
        ...
        <section class="video-style-two">
            <div class="inner-container" style="background-image: url(assets/images/background/9.jpg);">
                ...
                <div class="text">
                    ...
                    <div class="video-btn">
                        <a href="https://www.youtube.com/watch?v=nfP5N9Yc72A&amp;t=28s" class="lightbox-image" data-caption=""><i class="icon-play-arrow"></i>Watch Our Video</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="events-style-two sec-pad">
            <div class="auto-container">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 events-block">
                        <div class="events-block-two">
                            <div class="inner-box">
                                ...
                                <div class="content-box">
                                    <div class="category"><a href="event-details.php">For Free</a></div>
                        ...
                        <div class="events-block-two">
                            <div class="inner-box">
                                ...
                                <div class="content-box">
                                    ...
                                    <h3><a href="event-details.php">Pure Hearts Present Virtual Brain Game for Youth</a></h3>
                                    <div class="links"><a href="event-details.php">More Details</a></div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="more-btn centred"><a href="events.php" class="theme-btn btn-one">All Events</a></div>
            </div>
        </section>
        ...
        <section class="clients-section">
            <div class="outer-container">
                <div class="clients-carousel owl-carousel owl-theme owl-dots-none owl-nav-none">
                    <figure class="clients-logo-box"><a href="index-2.php"><img src="assets/images/clients/clients-logo-1.png" alt=""></a></figure>
                    <figure class="clients-logo-box"><a href="index-2.php"><img src="assets/images/clients/clients-logo-2.png" alt=""></a></figure>
                    <figure class="clients-logo-box"><a href="index-2.php"><img src="assets/images/clients/clients-logo-3.png" alt=""></a></figure>
                    <figure class="clients-logo-box"><a href="index-2.php"><img src="assets/images/clients/clients-logo-4.png" alt=""></a></figure>
                    <figure class="clients-logo-box"><a href="index-2.php"><img src="assets/images/clients/clients-logo-5.png" alt=""></a></figure>
                    <figure class="clients-logo-box"><a href="index-2.php"><img src="assets/images/clients/clients-logo-6.png" alt=""></a></figure>
                </div>
            </div>
        </section>
        <!-- clients-section end -->
        ...
        <!-- news-style-two -->
        <section class="news-style-two" style="background-image: url(assets/images/background/11.jpg);">
            <div class="auto-container">
                <div class="row clearfix">
                        ...
                        <div class="title-block">
                            ...
                            <div class="blog-post">
                                <div class="post">
                                    ...
                                    <h5><a href="blog-details.php">Aid for Country: <br />The Charity for Orphans</a></h5>
                                ...
                                <div class="post">
                                    ...
                                    <h5><a href="blog-details.php">I Want to Get <br />Every People Volunteer...</a></h5>
                                ...
                                <div class="post">
                                    ...
                                    <h5><a href="blog-details.php">The Last Day of World <br />Hunger Month</a></h5>
                        ...
                        <div class="news-block-one wow fadeInUp animated animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="content-box">
                                    <div class="text">
                                        <span class="post-date">03.03.2021</span>
                                        <div class="category"><a href="blog-details.php"># National Day</a></div>
                                        <h3><a href="blog-details.php">This is World Cancer Day, We Provide Care</a></h3>
                                        <p>Our being able do what we like best pleasure is to welcomed. . .</p>
                                    </div>
                                    <div class="info clearfix">
                                        <div class="link-box pull-left"><a href="blog-details.php">More Details</a></div>
                                        <div class="comment-box pull-right"><a href="blog-details.php"><i class="far fa-comment"></i>08 Cmts</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="news-block-one wow fadeInUp animated animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="content-box">
                                    <div class="text">
                                        <span class="post-date">24.02.2021</span>
                                        <div class="category"><a href="blog-details.php"># Treatment</a></div>
                                        <h3><a href="blog-details.php">I Want to Get Every People Volunteering</a></h3>
                                        <p>Our being able do what we like best pleasure is to welcomed. . .</p>
                                    </div>
                                    <div class="info clearfix">
                                        <div class="link-box pull-left"><a href="blog-details.php">More Details</a></div>
                                        <div class="comment-box pull-right"><a href="blog-details.php"><i class="far fa-comment"></i>03 Cmts</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="info-box">
                        ...
                        <div class="single-item">
                            ...
                            <div class="inner">
                                ...
                                <p>Mail to <br /><a href="tel:example@info.com">example@info.com</a></p>
                            </div>
                        </div>
                        <div class="single-item">
                            ...
                            <div class="inner">
                                ...
                                <p>54 Berrick Street, Boston MA 02115.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="shop-section sec-pad centred">
            <div class="auto-container">
                <div class="sec-title style-two centred">
                    <span class="top-text">Visit Our Store</span>
                    <h2>Help Charity with Another Way</h2>
                    <p>The master-builder of human happiness no one rejects, dislikes <br />or avoids  pleasure itself pleasure.</p>
                </div>
                <div class="row clearfix">
                        ...
                        <div class="shop-block-one wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box">
                                    ...
                                    <a href="product-details.php" class="cart-btn"><i class="icon-shopping-bag"></i><h6>Add to cart</h6></a>
                                </figure>
                                <div class="lower-content">
                                    ...
                                    <h5><a href="product-details.php">Kids Zebra Soft Toy</a></h5>
                                    <div class="price"><h5>£23.99</h5></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="shop-block-one wow fadeInUp animated animated" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    ...
                                    <h5><a href="product-details.php">Talking Tom Toy</a></h5>
                                    <div class="price"><h5>£34.99</h5></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12 shop-block">
                        <div class="shop-block-one wow fadeInUp animated animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box">
                                ...
                                <div class="lower-content">
                                    ...
                                    <h5><a href="product-details.php">Rocking Wood Chair</a></h5>
                                    <div class="price"><h5>£49.00 <del>£59.00</del></h5></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="shop-block-one wow fadeInUp animated animated" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    ...
                                    <h5><a href="product-details.php">Higadget Play Set</a></h5>
                                    <div class="price"><h5>£25.99</h5></div>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="more-btn"><a href="products.php" class="theme-btn btn-one">All Products</a></div>
            </div>
        </section>
        <!-- shop-section end -->
        ...
        <section class="main-footer">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                            <div class="footer-widget about-widget">
                                ...
                                <div class="widget-content">
                                    <p>Prevents our being able to do we like best, every pleasures is every pain avoided undertakes laborius physical exercise.</p>
                                    <div class="inner">
                                        <div class="icon-box"><i class="icon-charity"></i></div>
                                        <p>&copy; 2021 <a href="index-2.php">Pure Hearts,</a> All Rights Reserved.</p>
                                    </div>
                                    <div class="links"><a href="index-2.php"><i class="far fa-angle-right"></i>More About Us</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                            <div class="footer-widget post-widget">
                                ...
                                <div class="post-inner">
                                    <div class="post">
                                        <figure class="post-thumb"><a href="donation-details.php"><img src="assets/images/resource/footer-post-1.png" alt=""></a></figure>
                                        <h5>$250</h5>
                                        <h4><a href="donation-details.php">Rodha Thelma</a></h4>
                                        <span>California</span>
                                    </div>
                                    <div class="post">
                                        <figure class="post-thumb"><a href="donation-details.php"><img src="assets/images/resource/footer-post-2.png" alt=""></a></figure>
                                        <h5>$1200</h5>
                                        <h4><a href="donation-details.php">Luke Nobert</a></h4>
                                        <span>Newyork</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                            <div class="footer-widget gallery-widget">
                                ...
                                <div class="widget-content">
                                    <ul class="image-list clearfix">
                                        <li>
                                            <figure class="image">
                                                ...
                                                <a href="index-2.php"><i class="fas fa-expand-alt"></i></a>
                                            </figure>
                                        </li>
                                        <li>
                                            <figure class="image">
                                    ...
                                    <div class="more-links"><a href="index-2.php"><i class="far fa-angle-right"></i>View More</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="footer-bottom-two">
                <div class="auto-container">
                    <ul class="social-links clearfix">
                        <li><a href="index-2.php"><i class="fab fa-facebook-square"></i>Facebook</a></li>
                        <li><a href="index-2.php"><i class="fab fa-twitter-square"></i>Twitter</a></li>
                        <li><a href="index-2.php"><i class="fab fa-linkedin"></i>Linkedin</a></li>
                        <li><a href="index-2.php"><i class="fab fa-google-plus-square"></i>Google Plus</a></li>
                        <li><a href="index-2.php"><i class="fab fa-pinterest-square"></i>Pinterest</a></li>
                    </ul>
                </div>
            </div>
        </section>
                ...
                <div class="sidebar-widget-container">
                    ...
                    <div class="sidebar-info-contents">
                        <div class="content-inner">
                            <div class="logo">
                                <a href="index.php"><img src="assets/images/logo-4.png" alt="" /></a>
                            </div>
                            <div class="content-box">
                                <h4>About Us</h4>
...
<!-- Mirrored from st.ourhtmldemo.com/new/PureHearts/index-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 13:04:22 GMT -->
</html>
