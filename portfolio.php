...
<!-- Mirrored from st.ourhtmldemo.com/new/PureHearts/portfolio.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 13:05:34 GMT -->
<head>
<meta charset="utf-8">
            ...
            <div class="auto-container">
                <div class="sortable-masonry">
                    ...
                    <div class="items-container row clearfix">
                        <div class="col-lg-6 col-md-6 col-sm-12 masonry-item small-column all education activities awareness helping">
                            <figure class="image-box"><a href="assets/images/gallery/portfolio-1.jpg" class="lightbox-image" data-fancybox="gallery"><img src="assets/images/gallery/portfolio-1.jpg" alt=""></a></figure>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 masonry-item small-column all activities education health helping">
                            <figure class="image-box"><a href="assets/images/gallery/portfolio-2.jpg" class="lightbox-image" data-fancybox="gallery"><img src="assets/images/gallery/portfolio-2.jpg" alt=""></a></figure>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 masonry-item small-column all education awareness">
                            <figure class="image-box"><a href="assets/images/gallery/portfolio-3.jpg" class="lightbox-image" data-fancybox="gallery"><img src="assets/images/gallery/portfolio-3.jpg" alt=""></a></figure>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 masonry-item small-column all activities awareness health helping">
                            <figure class="image-box"><a href="assets/images/gallery/portfolio-4.jpg" class="lightbox-image" data-fancybox="gallery"><img src="assets/images/gallery/portfolio-4.jpg" alt=""></a></figure>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 masonry-item small-column all education awareness">
                            <figure class="image-box"><a href="assets/images/gallery/portfolio-5.jpg" class="lightbox-image" data-fancybox="gallery"><img src="assets/images/gallery/portfolio-5.jpg" alt=""></a></figure>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 masonry-item small-column all activities awareness health helping">
                            <figure class="image-box"><a href="assets/images/gallery/portfolio-6.jpg" class="lightbox-image" data-fancybox="gallery"><img src="assets/images/gallery/portfolio-6.jpg" alt=""></a></figure>
                        </div>
                    </div>
                </div>
                <div class="more-btn"><a href="portfolio.php" class="theme-btn btn-one">Load More</a></div>
            </div>
        </section>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                            <div class="footer-widget about-widget">
                                ...
                                <div class="text">
                                    ...
                                    <a href="index.php" class="theme-btn btn-one">Join With Us</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                            ...
                            <div class="footer-widget links-widget ml-30">
                                ...
                                <div class="widget-content">
                                    <ul class="links-list clearfix">
                                        ...
                                        <li><a href="index.php">Donate Securities</a></li>
                                        <li><a href="index.php">Fundraise</a></li>
                                        <li><a href="index.php">Crisis Relief Centre</a></li>
                                        <li><a href="index.php">Round Up to Give</a></li>
                ...
                <div class="auto-container">
                    <div class="inner-box clearfix">
                        <div class="copyright pull-left">
                            <p>&copy; 2021 <a href="index.php">Pure Hearts,</a> All Rights Reserved.</p>
                        </div>
                        <ul class="footer-card pull-right clearfix">
                            ...
                            <li><a href="index.php"><img src="assets/images/resource/card-5.png" alt=""></a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<!-- Mirrored from st.ourhtmldemo.com/new/PureHearts/portfolio.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 13:05:38 GMT -->
</html>
