...
<!-- Mirrored from st.ourhtmldemo.com/new/PureHearts/products.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 13:06:15 GMT -->
<head>
<meta charset="utf-8">
...
<body>
    ...
    <div class="boxed_wrapper">
        ...
        <!-- shop-page-section -->
        <section class="shop-page-section sec-pad centred">
            <div class="auto-container">
                <div class="short-box clearfix">
                    <div class="text pull-left">
                        <p>Showing 1 - 8 of 14 results</p>
                    </div>
                    <div class="item-short pull-right clearfix">
                        <p>Sort by:</p>
                        <div class="select-box">
                            <select class="wide">
                               <option data-display="Popularity">Popularity</option>
                               <option value="1">Best Sale</option>
                               <option value="2">Upcoming Product</option>
                ...
                <div class="pagination-wrapper centred">
                    <ul class="pagination clearfix">
                        <li><a href="products.php"><i class="fas fa-arrow-left"></i></a></li>
                        <li><a href="products.php" class="current">1</a></li>
                        <li><a href="products.php">2</a></li>
                        <li><a href="products.php"><i class="fas fa-arrow-right"></i></a></li>
                    </ul>
                </div>
            </div>
        </section>
...
<!-- Mirrored from st.ourhtmldemo.com/new/PureHearts/products.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 13:06:17 GMT -->
</html>
