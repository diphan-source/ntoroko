...
<!-- Mirrored from st.ourhtmldemo.com/new/PureHearts/cart.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 13:06:17 GMT -->
<head>
<meta charset="utf-8">
            ...
            <div class="auto-container">
                <div class="cart-outer">
                    <div class="totle-table clearfix">
                        <div class="item pull-left"><p>Your Cart: 2 Items</p></div>
                        <div class="total pull-right"><p>Total: 15,797</p></div>
                    </div>
                                ...
                                <tr>
                                    <td class="prod-column">
                                        <div class="column-box">
                                            <figure class="prod-thumb"><a href="cart.php"><img src="assets/images/resource/shop/cart-1.png" alt=""></a></figure>
                                            <h5>Tortoise Reptile Toy</h5>
                                        </div>
                                    </td>
                                    <td class="qty"><input type="number" value="2" name="quantity"></td>
                                    <td class="sub-total">£25.99</td>
                                    <td class="total-price">£51.98</td>
                                    <td><button class="remove-btn"><i class="icon-close"></i></button></td>
                                </tr>
                                <tr>
                                    <td class="prod-column">
                                        <div class="column-box">
                                            <figure class="prod-thumb"><a href="cart.php"><img src="assets/images/resource/shop/cart-2.png" alt=""></a></figure>
                                            <h5>Kids Zebra Soft Toy</h5>
                                        </div>
                                    </td>
                                    <td class="qty"><input type="number" value="3" name="quantity"></td>
                                    <td class="sub-total">£23.99</td>
                                    <td class="total-price">£71.97</td>
                                    <td><button class="remove-btn"><i class="icon-close"></i></button></td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 column clearfix">
                            <div class="btn-box pull-right clearfix">
                                ...
                                <button type="submit" class="theme-btn btn-one">Checkout</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from st.ourhtmldemo.com/new/PureHearts/cart.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 13:06:18 GMT -->
</html>
