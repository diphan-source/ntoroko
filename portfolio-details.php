...
<!-- Mirrored from st.ourhtmldemo.com/new/PureHearts/portfolio-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 13:05:46 GMT -->
<head>
<meta charset="utf-8">
                ...
                <div class="row clearfix">
                        ...
                        <div class="portfolio-sidebar">
                            <div class="portfolio-info">
                                ...
                                <ul class="social-links clearfix">
                                    <li><a href="portfolio-details.php"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="portfolio-details.php"><i class="fab fa-twitter"></i></a></li>
                                    <li><a href="portfolio-details.php"><i class="fab fa-linkedin-in"></i></a></li>
                                    <li><a href="portfolio-details.php"><i class="fab fa-pinterest-p"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                        <div class="portfolio-details-content">
                            <div class="inner-box">
                                <div class="text">
                                    <h2>Educate a Poor Children</h2>
                                    <p>To take a trivial example, which of us ever undertakes laborious physical exercise, except to obtain some advantage from it? But who has any right to find fault with a man who chooses to enjoy a pleasure that has no annoying consequences. Ever undertakes laborious physical exercise, except to obtain some advantage from it? But who has any right to find fault one who avoids a pain that produces have to be repudiated and annoyances accepted.</p>
                                    <p>Find fault with a man who chooses to enjoy a pleasure that has annoying consequences undertakes laborious physical exercise, except to obtain some advantage from it? But who has any right to find fault one who avoids a pain that produces.</p>
                                </div>
                                <div class="image-box">
                                    <div class="row clearfix">
                                        <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                                            <figure class="image"><img src="assets/images/gallery/portfolio-24.jpg" alt=""></figure>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                                            <figure class="image"><img src="assets/images/gallery/portfolio-25.jpg" alt=""></figure>
                                        </div>
                                    </div>
                                </div>
                                <div class="text project-summary">
                                    <h3>Project Summary</h3>
                                    <p>When our power of choice is untrammelled and when nothing prevents our being able to dowhat we like best every pleasures  to be welcomed every pain avoided.</p>
                                ...
                                <div class="text project-solution">
                            ...
                            <div class="nav-btn-box clearfix">
                                <div class="single-item text-left pull-left">
                                    ...
                                    <h6>Awareness</h6>
                                    <h5><a href="product-details.php">Enabling, Encouraging <br />& Excelling</a></h5>
                                </div>
                                <div class="single-item text-right pull-right">
                                    <figure class="thumb-box"><img src="assets/images/gallery/btn-2.jpg" alt=""></figure>
                                    <h6>Health</h6>
                                    <h5><a href="product-details.php">Expansion of Educate <br />Girls Programme</a></h5>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- Mirrored from st.ourhtmldemo.com/new/PureHearts/portfolio-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 13:05:49 GMT -->
</html>
