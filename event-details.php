            ...
            <div class="auto-container">
                <div class="event-details-content">
                    <div class="upper-box centred">
                        ...
                        <figure class="image-box"><img src="assets/images/events/events-15.jpg" alt=""></figure>
                    </div>
                    <div class="tabs-box">
                                ...
                                <div class="overview-inner">
                                    ...
                                    <div class="lower-box clearfix">
                                        <div class="btn-box pull-left">
                                            <a href="event-details.php" class="theme-btn btn-one">Register</a>
                                            <span>$180</span>
                                        </div>
                                        <div class="share-option pull-right">
                                            <h5>Share With Friends<a href="event-details.php"><i class="fas fa-share-alt"></i></a></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-12 single-column">
                                            <div class="single-item">
                                                ...
                                                <ul class="social-links clearfix">
                                                    <li><a href="event-details.php"><i class="fab fa-facebook-f"></i></a></li>
                                                    <li><a href="event-details.php"><i class="fab fa-twitter"></i></a></li>
                                                    <li><a href="event-details.php"><i class="fab fa-linkedin-in"></i></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-6 col-sm-12 single-column">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-8 col-md-12 col-sm-12 form-column">
                                            <div class="form-inner">
                                                <form action="https://st.ourhtmldemo.com/new/PureHearts/contact.php" method="post" class="default-form">
                                                    <div class="row clearfix">
                                            ...
                                            <div class="sidebar-inner">
                                                <div class="event-organizer">
                                                    ...
                                                    <ul class="list-item clearfix">
                                                        ...
                                                        <li>Social <p><a href="event-details.php">Facebook</a>&nbsp;<a href="event-details.php">Twitter</a></p></li>
                                                    </ul>
                                                </div>
                                                <div class="map-inner">
                                                    <div 
